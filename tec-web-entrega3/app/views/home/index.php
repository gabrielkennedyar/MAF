        ...
        <nav class="navbar navbar-expand-sm bg-light navbar-light">
            ...
            <div class="navbar-nav col-sm-7" style="background-color: #B6D422; margin-top: 15px; margin-bottom: -25px;">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../templates/contato.php">Contato</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../templates/faq.php">FAQ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../templates/register.php">Registrar</a>
                    </li>
            ...
            <div>
                ...
                <p>
                    <span style="color:#395143; font-size: 18px;">
                        <i class="far fa-hand-point-right"></i> Welcome!
                    </span>
                </p>
            </div>
