...
<head>
    ...
    <title>Meu Assistente Financeiro - FAQ</title>
    <!-- Bootstrap Core -->
    ...
    <main>
        <div class="container-fluid">
            ...
            <div>
                ...
                <p>
                    <span style="color:#395143; font-size: 18px;">
                        <i class="far fa-hand-point-right"></i> FAQ - Perguntas Frequentes!
                    </span>
                </p>
            </div>
            ...
            <div class="row" style="text-align: justify;">
                ...
                <div class="col-md-6">
                    <ol>
                        <li><strong>O que é o MAF?</strong></li>
                        <p>O MAF é o Meu Assistente Financeiro mais completo do mercado...</p>
                        <li><strong>Pergunta 2?</strong></li>
                        ...
                        <li><strong>Pergunta 3?</strong></li>
                        <p>ew quips galvanized the mock jury box. Quick brown dogs jump over the lazy fox. The jay, pig, fox, zebra, and my wolves quack! Blowzy red vixens fight for a quick jump.</p>
                        <li><strong>Pergunta 4?</strong></li>
                        ...
                        <li><strong>Pergunta 5?</strong></li>
                        <p>O MAF é o Meu Assistente Financeiro mais completo do mercado...</p>
                    </ol>
                </div>
                <div class="col-md-3">
