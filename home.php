            ...
            <div>
                ...
                <p>
                    <span style="color:#395143; font-size: 18px;">
                        <i class="far fa-hand-point-right"></i> Você está em: Página Principal
                    </span>
                </p>
            </div>
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Hello. It`s me!</p>
                        </div>
                        <div class="card-footer">
                            <a href="#"><small class="text-muted float-left">View details</small><i class="fas fa-caret-square-right float-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm">
                ...
                <div class="col-sm">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Special title treatment</h5>
                            <p class="card-text float-left">Hello. It`s me!</p>

                        </div>
                        <div class="card-footer">
                            <a href="#">
                                <small class="text-muted float-left">View details</small>
                                <i class="fas fa-caret-square-right float-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
